...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record7<UUID, String, String, String, String, Boolean, Instant> {
    ...
    /**
     * Setter for <code>user.user.second_factor_auth</code>.
     */
    public UserRecord setSecondFactorAuth(Boolean value) {
        set(5, value);
        return this;
    }

    /**
     * Getter for <code>user.user.second_factor_auth</code>.
     */
    public Boolean getSecondFactorAuth() {
    ...
    @Override
    public Row7<UUID, String, String, String, String, Boolean, Instant> valuesRow() {
    ...
    public Field<Boolean> field6() {
        return User.USER.SECOND_FACTOR_AUTH;
    }
    ...
    @Override
    public UserRecord values(UUID value1, String value2, String value3, String value4, String value5, Boolean value6, Instant value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(UUID id, String name, String email, String password, String state, Boolean secondFactorAuth, Instant createdAt) {
        super(User.USER);
        ...
        setState(state);
        setSecondFactorAuth(secondFactorAuth);
