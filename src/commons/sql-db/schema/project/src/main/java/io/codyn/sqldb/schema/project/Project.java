...
public class Project extends SchemaImpl {
     ...
     */
    public final io.codyn.sqldb.schema.project.tables.Project PROJECT = io.codyn.sqldb.schema.project.tables.Project.PROJECT;
    ...
    public final List<Table<?>> getTables() {
        return Arrays.<Table<?>>asList(
            io.codyn.sqldb.schema.project.tables.Project.PROJECT,
