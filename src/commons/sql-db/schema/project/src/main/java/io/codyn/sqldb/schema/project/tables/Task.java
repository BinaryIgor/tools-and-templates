...
import io.codyn.sqldb.schema.project.tables.records.TaskRecord;
...
public class Task extends TableImpl<TaskRecord> {
    ...
    public io.codyn.sqldb.schema.project.tables.Project project() {
        if (_project == null)
            _project = new io.codyn.sqldb.schema.project.tables.Project(this, Keys.TASK__TASK_PROJECT_ID_FKEY);
