...
public class TestChannel implements Channel {
    ...
    public final List<PublishedArgs> publishedArgs = new LinkedList<>();
    public RuntimeException publishException;
    ...
    public void basicPublish(String exchange, String routingKey, AMQP.BasicProperties props,
        ...
        publishedArgs.add(new PublishedArgs(exchange, routingKey, new String(body, StandardCharsets.UTF_8)));
    ...
    @Override
    public AMQP.Exchange.UnbindOk exchangeUnbind(String destination, String source,
    ...
    public AMQP.Queue.DeclareOk queueDeclare() throws IOException {
        return new AMQImpl.Queue.DeclareOk(TestRandom.string(), 0, 0);
    }
    ...
    public record PublishedArgs(String exchange, String routingKey, String body) {
    }
}
