...
import io.codyn.commons.sqldb.schema.user.Indexes;
...
public class ActivationToken extends TableImpl<ActivationTokenRecord> {
    ...
    public io.codyn.commons.sqldb.schema.user.tables.User user() {
        if (_user == null)
            _user = new io.codyn.commons.sqldb.schema.user.tables.User(this, Keys.ACTIVATION_TOKEN__ACTIVATION_TOKEN_ID_FKEY);
