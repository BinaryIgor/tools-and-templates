 ...
 */
package io.codyn.commons.sqldb.schema.user.tables;


import io.codyn.commons.sqldb.schema.user.Keys;
import io.codyn.commons.sqldb.schema.user.User;
...
public class Role extends TableImpl<RoleRecord> {
     ...
     */
    public final TableField<RoleRecord, String> VALUE = createField(DSL.name("value"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    private transient io.codyn.commons.sqldb.schema.user.tables.User _user;

    public io.codyn.commons.sqldb.schema.user.tables.User user() {
        if (_user == null)
            _user = new io.codyn.commons.sqldb.schema.user.tables.User(this, Keys.ROLE__ROLE_ID_FKEY);
