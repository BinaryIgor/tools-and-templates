...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record8<UUID, String, String, String, String, Boolean, String, LocalDateTime> {
    ...
    @Override
    public Row8<UUID, String, String, String, String, Boolean, String, LocalDateTime> valuesRow() {
    ...
    @Override
    public UserRecord values(UUID value1, String value2, String value3, String value4, String value5, Boolean value6, String value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(UUID id, String name, String email, String password, String state, Boolean secondFactorAuthentication, String externalAuthentication, LocalDateTime createdAt) {
        super(User.USER);
