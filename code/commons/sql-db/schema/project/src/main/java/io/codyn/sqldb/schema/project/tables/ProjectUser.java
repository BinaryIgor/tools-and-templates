 ...
 */
package io.codyn.sqldb.schema.project.tables;


import io.codyn.sqldb.schema.project.Keys;
import io.codyn.sqldb.schema.project.Project;
import io.codyn.sqldb.schema.project.tables.records.ProjectUserRecord;
...
public class ProjectUser extends TableImpl<ProjectUserRecord> {
    ...
    private transient io.codyn.sqldb.schema.project.tables.Project _project;

    public io.codyn.sqldb.schema.project.tables.Project project() {
        if (_project == null)
            _project = new io.codyn.sqldb.schema.project.tables.Project(this, Keys.PROJECT_USER__PROJECT_USER_PROJECT_ID_FKEY);
